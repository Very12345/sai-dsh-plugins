...
test('sai UI skin targets the official DSH DOM contracts', async () => {
  ...
  assert.doesNotMatch(source, /sai:navigation-toggle/)
  assert.match(source, /探索未至之境/)
  assert.match(source, /从 sai 开始/)
  assert.match(source, /viewBox="0 0 182 24"/)
  assert.match(source, /sai-dsh-wordmark/)
  ...
  assert.match(standalone, /从 sai 开始/)
  assert.match(standalone, /sai-dsh-wordmark/)
